...
public class OrderTest extends TestBase {
    ...
    public void testM30a() {
        domainObject.m30a("1", "2");
        assertEquals("wrong check history size", 7, checkHistory.size());
        assertTrue("wrong check", checkHistory.get(0).contains(domainObject, SecureAction.EXECUTE));
        assertTrue("wrong check", checkHistory.get(1).contains(domainObject, SecureAction.UPDATE));
